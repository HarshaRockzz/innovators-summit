  ...
  return (
    <nav className="bg-gray-900/25 text-white p-4 flex justify-between items-center">
      <div className="flex items-center space-x-2 text-xl font-bold">
        <img
          src="https://qph.cf2.quoracdn.net/main-qimg-d8f7d05eea0265f441ed55b66871fcc2"
          alt="Innovators' Summit Logo"
          className="h-8 w-8 object-cover rounded-full"
        />
        <span>Innovators' Summit 2024</span>
      </div>
      ...
      {isOpen && (
        ...
        >
          <div className="flex flex-col space-y-4">
            ...
            <a
              href="https://forms.gle/KhGxjmsPLMMH6CLi8"
              className="font-semibold"
              onClick={() => setIsOpen(false)}
            >
              Register
      ...
      <div className="hidden md:flex md:items-center md:space-x-4">
        ...
        <a
          href="https://forms.gle/KhGxjmsPLMMH6CLi8"
          className="ml-4 bg-green-500 text-white font-bold py-2 px-4 rounded-lg hover:bg-green-600 transition duration-300 ease-in-out"
        >
          Register Now
        </a>
      </div>
